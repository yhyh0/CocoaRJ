...
// Should call InitializeBlog() before calling this function.
void FillNetParamater(unsigned char ForFill[]) {

	if (blogIsInitialized == 0){
		fprintf(stdout, "Blog algorithm not initialized yet\n");
		fflush(stdout);
...
void Blog() { 
	static unsigned char Table[]={ 
				0x00,0x00,0x21,0x10,0x42,0x20,0x63,0x30,0x84,0x40,
 ...
 static unsigned char sCircleBase[0x15]={ 
		0x00,0x00,0x13,0x11,0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00, 
